...
function activate(context) {
	...
	const disposable2 = vscode.commands.registerCommand('gitter-committer.gcpc', async function () {
	...
	const disposable3 = vscode.commands.registerCommand('gitter-committer.gcpull', async function () {
		const userInput = await vscode.window.showInputBox({
	...
	const disposable4 = vscode.commands.registerCommand('gitter-committer.gccommit', async function () {
		const userInput = await vscode.window.showInputBox({
			placeHolder: "--staged --model gemini",
